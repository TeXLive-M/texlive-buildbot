...
builder_list = [
    ...
    BuildWorker(worker = 'solaris10-sparc',             code = 'csw', profile = builder_profiles['solaris10-sparc'],  name = 'solaris-sparc.csw',        arch = 'sparc',   tlname = 'sparc-solaris',       upload = True),
    ...
    BuildWorker(worker = 'pragma-openbsd73-amd64',      code = 'prg', profile = builder_profiles['openbsd'],          name = 'openbsd-amd64-7.3.prg',    arch = 'amd64',   tlname = 'amd64-openbsd7.3',    upload = True),
    ...
    BuildWorker(worker = 'pragma-linux-centos7-x86_64', code = 'prg', profile = builder_profiles['linux'],            name = 'linux-x86_64-centos7.prg', arch = 'x86_64',  tlname = 'x86_64-linux',        upload = True),
