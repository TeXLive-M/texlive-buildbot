...
#   BuildWorker(slave = 'pragma-openbsd6.4-amd64',     code = 'prg', profile = builder_profiles['openbsd'],          name = 'openbsd-amd64-6.4.prg',    arch = 'amd64',   tlname = 'amd64-openbsd6.4',    upload = True),
