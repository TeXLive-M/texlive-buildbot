...
builder_list = [
    ...
    BuildWorker(worker = 'pragma-openbsd69-i386',       code = 'prg', profile = builder_profiles['openbsd'],          name = 'openbsd-i386-6.9.prg',     arch = 'i386',    tlname = 'i386-openbsd6.9',     upload = True),
    BuildWorker(worker = 'pragma-openbsd70-i386',       code = 'prg', profile = builder_profiles['openbsd'],          name = 'openbsd-i386-7.0.prg',     arch = 'i386',    tlname = 'i386-openbsd7.0',     upload = True),
    BuildWorker(worker = 'pragma-openbsd69-amd64',      code = 'prg', profile = builder_profiles['openbsd'],          name = 'openbsd-amd64-6.9.prg',    arch = 'amd64',   tlname = 'amd64-openbsd6.9',    upload = True),
    BuildWorker(worker = 'pragma-openbsd70-amd64',      code = 'prg', profile = builder_profiles['openbsd'],          name = 'openbsd-amd64-7.0.prg',    arch = 'amd64',   tlname = 'amd64-openbsd7.0',    upload = True),
